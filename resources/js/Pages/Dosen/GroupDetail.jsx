        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                            ...
                            <div className="space-y-3">
                                {anggota.map((user) => (
                                    <div key={user.id} className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                                        ...
                                        {/* Deteksi Otomatis AI: Jika Inaktif > 3 hari (data dikirim dari Controller) */}
                                        {user.is_inactive && (
                                            <button
                    ...
                    {/* --- AREA BAWAH: TIMELINE JEJAK AKTIVITAS --- */}
                            ...
                            <div className="relative border-l-2 border-slate-200 dark:border-slate-700 ml-4 space-y-8">
                                {logs.length > 0 ? logs.map((log) => (
                                    ...
                                    <div className="text-center py-10">
                                        <p className="text-slate-400 italic text-sm">Belum ada jejak aktivitas terdeteksi untuk kelompok ini.</p>
                                    </div>
                                )}
                            </div>
                        </div>
