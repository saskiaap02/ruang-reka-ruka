...
export default function ClassAccessList({ daftarKelas }) {
    const copyToClipboard = (text) => {
        ...
        // Pakai toast atau alert yang lebih estetik jika ada, tapi ini fungsional:
                    ...
                    {daftarKelas?.map((kelas) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <p className="font-black text-white text-sm tracking-tight group-hover:text-blue-400 transition-colors uppercase">
                                    {kelas.mata_kuliah}
                                </p>
