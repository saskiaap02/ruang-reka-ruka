                        ...
                        <form onSubmit={submitKelas} className="space-y-5">
                            <div>
                                ...
                                <input type="text" required value={data.mata_kuliah} onChange={e => setData('mata_kuliah', e.target.value)}
                                    className="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white shadow-sm"
                            ...
                            <div className="pt-4 border-t border-slate-200 dark:border-slate-700 text-center">
                                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 mb-3 uppercase">Bobot Penilaian (%)</h4>
                            ...
                            <div className="flex justify-end gap-3 mt-8">
                                <button type="button" onClick={() => setIsModalOpen(false)} className="px-6 py-2 text-slate-500 font-bold">Batal</button>
                                <button type="submit" disabled={processing} className="px-6 py-2 bg-blue-600 text-white rounded-xl font-bold shadow-lg shadow-blue-500/30">
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl shadow-sm border border-red-200 dark:border-red-900/50 relative">
                            ...
                            <p className="text-2xl font-bold text-red-700 dark:text-red-300">{kelompokKritis?.length || 0} Kelompok Bermasalah</p>
                        </div>
                    </div>
                                        ...
                                        <div key={kelas.id} className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button onClick={() => copyToClipboard(kelas.invite_code)} className="p-1.5 bg-slate-200 dark:bg-slate-700 hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors rounded">
                    ...
                    <div className="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-xl border border-slate-200 dark:border-slate-700">
                        <div className="p-6 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 flex justify-between items-center">
                            ...
                            <span className="bg-white dark:bg-slate-700 text-[10px] font-bold px-3 py-1 rounded-full border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 flex items-center gap-2">
                                        ...
                                        daftarKelompok.map((kelompok) => (
                                            <tr key={kelompok.id} className="border-b border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                                <td className="p-4">
                                                    ...
                                                    <p className="text-[10px] text-slate-500 uppercase font-medium">{kelompok.proyek}</p>
                                                </td>
                                                <td className="p-4">
                                                ...
                                                <td className="p-4 text-center">
                                                    <button className="text-[10px] font-bold uppercase tracking-widest text-blue-600 border border-blue-200 px-2 py-1 rounded hover:bg-blue-50 transition-all">Detail</button>
                                                </td>
                                            </tr>
                                        ))
                                    ) : (
